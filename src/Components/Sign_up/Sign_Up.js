                ...
                <div className="signup-form">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            {phoneError && (
                                <div style={{ color: "red", fontSize: "0.9rem" }}>{phoneError}</div>
                            )}
                        </div>
                        ...
                        <div className="btn-group">
                            ...
                            {/* Submit button */}
                            <button type="reset" className="btn btn-danger mb-2 waves-effect waves-light" onClick={() => { setPhone(""); setPhoneError(""); }}>
                                Reset
                            </button>
                            {/* Reset button */}
                        </div>
